...
with col[0]:
    with st.container(border=True):
        selected_option = st.selectbox("Pilih Modul", ['REKAP MENTAH','REKAP PENYESUAIAN INPUTAN IA','REKAP DATA 42.02','REKAP DATA BOM-DEVIASI','PENYESUAIAN IA','PROMIX','WEBSMART (DINE IN/TAKEAWAY)'])
        uploaded_file = st.file_uploader("Upload File", type=["zip",'xlsx'])
